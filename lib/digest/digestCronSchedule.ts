 ...
 *
 * **Vercel Hobby:** each cron may run **at most once per day** — do not use comma lists or
 * multiple hourly slots; deployment will fail. Pro can use finer schedules.
 *
 * `0 13 * * *` ≈ 8:00 AM Eastern Standard Time / 9:00 AM Eastern Daylight Time in Toronto.
 */
