      ...
      <section className="mx-auto grid min-h-screen w-full max-w-6xl grid-cols-1 gap-10 px-6 py-10 md:grid-cols-2 md:items-center md:px-10">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <button
            ...
            disabled={isLoading}
            className="mt-8 flex w-full items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-medium text-slate-800 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
          >
